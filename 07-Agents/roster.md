...
- **personal-life is not a subagent either.** Every job needs Samuel's answer in the moment, which a subagent can't get. It runs in the main session with its profile loaded. **content** runs the same way, for the same reason.
