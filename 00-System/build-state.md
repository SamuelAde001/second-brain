...
- **Next action:** (1) ~~Connect the sheet~~ **Done 2026-09-22:** connected, Cowrywise gap closed, sheet matches the ledger. Next finance runs: the September close on 2026-09-30, and payday when the September 70% lands. (2) Phase 4: **personal-life agent next** (TickTick), then content, then the job skills (`brainstorm`, `plan`, `money-check`, `systemize`, `commit`).
