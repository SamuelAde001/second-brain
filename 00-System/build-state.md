...
- **Next action:** two tracks. (1) **Scripnals guide library by 2026-09-27** (a dated promise to the devs) → `03-Areas/scripnals/guide-library-brief.md`. (2) Phase 4: **finance agent next** (brief: [[03-Areas/finances/finance-agent-plan|finance agent plan]]), then personal-life (TickTick), then content.
