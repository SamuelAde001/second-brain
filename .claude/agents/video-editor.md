...
description: >-
  ...
  Resolve MCP.
model: sonnet
tools: Read, Glob, Grep, Write, Edit, Bash, SendUserFile, mcp__DaVinci_Resolve__get_resolve_status, mcp__DaVinci_Resolve__get_whats_new, mcp__DaVinci_Resolve__run_script, mcp__DaVinci_Resolve__search_scripting_api, mcp__DaVinci_Resolve__get_scripting_api, mcp__DaVinci_Resolve__get_scripting_docs, mcp__DaVinci_Resolve__list_luts, mcp__DaVinci_Resolve__generate_lut, mcp__DaVinci_Resolve__list_dctls, mcp__DaVinci_Resolve__update_dctl
---

<!-- GENERATED by 00-System/scripts/build_adapters.py from 07-Agents/video-editor/profile.md for claude-code. Edit the profile, then re-run the script. -->
