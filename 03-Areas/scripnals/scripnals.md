...
**Same day:** the AI spec was written and approved → [[03-Areas/scripnals/ai-workflow|AI workflow]] (PDF built for the devs). The bug list is drafted for a DM → [[03-Areas/scripnals/dev-bug-list|Bug list]]. **Guide library v1 drafted the same day** → [[03-Areas/scripnals/guides/guide-library|Guide library]] ([[03-Areas/scripnals/guide-library-research|research]]). Spec v1.1 approved with his changes. **Next:** Samuel reads the guides, a test on 3–4 real drafts, then send by 2026-09-27. Samuel's 11-item plan → [[03-Areas/scripnals/roadmap|Roadmap]].
...
- **Start here for AI work:** [[03-Areas/scripnals/guides/guide-library|Guide library]] · [[03-Areas/scripnals/guide-library-research|Guide library research]] · [[03-Areas/scripnals/ai-workflow|AI workflow (spec v1.1, approved)]] · [[03-Areas/scripnals/guide-library-brief|Guide library brief (done)]]
