...
Marked TBD in the source doc and still unanswered:

- Monetisation model — subscription, freemium, one-time, or bundled with ecosystem membership?
- Platform — iOS, Android, or both?
- Pricing relative to Academy / Community / Mentorship.
- Actual build status, stack, and whether anyone outside Samuel has used it.
