...
- **Overview:** a big title with the as-of date and plan month. Boxed sections, each in its own colour: where the money is (teal) · goals with a progress bar (violet) · money flow (green) · plan vs actual (blue) · subscriptions (pink) · every month (amber: bank at start, money in, from pots, spent, into pots, bank at end; each month name links to its tab).
