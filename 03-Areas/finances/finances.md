...
Samuel's money: one payer, two paydays, a fixed obligations floor, four pots and two dated goals. Plus the rules that exist because NGN 595,250 of "savings" evaporated in three months.

**No account numbers, card details or credentials live here** — accounts by nickname only, AGENTS.md §6.

## Why it matters

Income is variable, USD-denominated, paid in two stages, and comes entirely from **one payer whose volume decisions Samuel does not control.** The obligations floor is NGN 936,800/month and does not flex. Between those two facts sits every goal he has.

## Current status — as of 2026-09-20

**The system is the Accountability Engine's**, confirmed by Samuel: *"The Engine's financial system is the most up to date and current system, use that system, it has the most current and correct data."* Its rules, pots, obligations and goals are now active in the Brain. The live Google Sheet **"My Claude Budget"** (last modified 2026-09-16) is the budgeting layer.
...
See [[03-Areas/finances/finances-goals|Goals]] — NGN 1,000,000 by 31 Dec 2026, NGN 3,000,000 more by 31 Jul 2027, emergency fund NGN 300,000 from January 2027, building project NGN 500,000/month.
...
- [[03-Areas/video-editing/video-editing|Video editing]] — the income source
- [[03-Areas/academy/academy|Academy]] — the course, which is a finance lever
- [[02-Me/about-samuel|About Samuel]] — the building project and the house are why the number exists
