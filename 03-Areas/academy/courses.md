...
From the Academy project-setup doc, 2026-07-23. The build spec called this "Called to Edit Academy" — the source doc is more specific: there are three courses under the Academy, and the line between them is deliberate.
...
- **Outcome:** a student goes from a blank idea to a published piece of content that has a real chance of landing.
- **Level:** beginner-accessible language.
...
- **Positioning:** monetisation. Turning editing into a marketable, sellable skill, not just a tool for personal content.
- **Outcome:** a student can offer editing as a paid service or role.
- **Level:** assumes real technical fluency.

## The hard line between them
...
**Known design risk, flagged in the source doc:** Create Academy's "editing fundamentals" and Edit Beginners' "basic editing skills" blur together if not deliberately scoped. Button-by-button software instruction belongs entirely in the Edit courses.
