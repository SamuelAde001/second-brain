...
The standing rules for Samuel's content. Extracted from the Claude operating-instructions doc he wrote for his script reviewer (dated 2026-07-24). These are his rules, written by him, so they carry.
...
5. **Simple, proper English** — clear enough for a 15-year-old. One or two Pidgin phrases in narration sections only, for warmth or comic timing. Pidgin is never the main voice.
6. **No guru tone, ever.** No lecturing, no fake perfection, no pretending he has it all figured out.

## Script shape

Hook → Context → Conflict → Pivot → Resolution → Mantra, or a natural variation.

## Length

- 60 seconds for tighter, punchier pieces.
- 90 seconds or more for calmer talking-head storytelling.
...
## Why his content flops, in his own ranking

1. A weak or missing hook — the number one reason.
2. No clear benefit to the viewer — the number two reason.
...
See also [[content-pillars]], [[script-review-checklist]]. Back to [[03-Areas/personal-brand/personal-brand|Personal brand]]
